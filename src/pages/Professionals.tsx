export function Professionals() {
  return (
    <>
      <h2 className="mt-10 font-bold text-3xl text-center p-3 text-pink-900">
            ...
            <div className="pb-6">
                ...
                <div className="w-full text-center">
                  <div className="flex justify-center pt-8 pb-0 lg:pt-4">
                    <div className="flex space-x-2">
                      <a
                        className="p-1 -m-1 text-gray-400 hover:text-pink-900 focus:outline-none focus-visible:ring-2 ring-primary"
              ...
              <div className="relative h-6 overflow-hidden translate-y-6 rounded-b-xl">
                <div className="absolute flex -space-x-12 rounded-b-2xl">
                  <div className="w-36 h-8 transition-colors duration-200 delay-75 transform skew-x-[35deg] bg-violet-400/90 group-hover:bg-violet-600/90 z-10"></div>
                  <div className="w-28 h-8 transition-colors duration-200 delay-100 transform skew-x-[35deg] bg-violet-300/90 group-hover:bg-violet-500/90 z-20"></div>
                  <div className="w-28 h-8 transition-colors duration-200 delay-150 transform skew-x-[35deg] bg-violet-200/90 group-hover:bg-violet-400/90 z-30"></div>
                  <div className="w-28 h-8 transition-colors duration-200 delay-200 transform skew-x-[35deg] bg-violet-100/90 group-hover:bg-violet-300/90 z-40"></div>
                  <div className="w-28 h-8 transition-colors duration-200 delay-300 transform skew-x-[35deg] bg-violet-50/90 group-hover:bg-violet-200/90 z-50"></div>
                </div>
              </div>
            </div>
          </div>
